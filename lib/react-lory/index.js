...
var ReactLory = function (_Component) {
  ...
  _createClass(ReactLory, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _lory.lory)(this.sliderNode, _extends({}, this.props, classes));
    }
  }, {
    key: 'getClassName',
...
ReactLory.propTypes = {
  ...
  classNameFrame: _react.PropTypes.string,
  classNameSlideContainer: _react.PropTypes.string,
  classNamePrevCtrl: _react.PropTypes.string,
  classNameNextCtrl: _react.PropTypes.string
};
